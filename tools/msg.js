...
CitybusMSG = '<span style="color: red;font-size:20px;font-weight:bold;">台南市民搭乘市區公車(0~99路，33及61路除外)，刷市民卡享平日半價、假日免費優惠！</span><br /><span style="color: red;font-size:18px;font-weight:bold;">（本項優惠至109/12/31止）</span><p></p>';
...
H_message = '<span style="color:red;">H</span>表示僅假日行駛：指星期六、日行駛，且包含國定假日';
