...
red_1_interval_stop = [
["臺南轉運站","臺南火車站","縣知事官邸","東門圓環","東門教會","東門城","龍山寺","衛生局"], // 臺南
...
red_1_main_stop_name = ["臺南<br />轉運站","臺南<br />火車站","太子廟","大人廟","媽祖廟","歸仁區公所<br />(中正北路)","關廟國中","關廟<br />轉運站"];
red_1_main_stop_time_consume = [0, 5, 25, 30, 35, 40, 50, 55];
red_1_important_stop = [0, 1, 5, 7]; // 臺南轉運站, 臺南火車站, 歸仁區公所(中正北路), 關廟轉運站
