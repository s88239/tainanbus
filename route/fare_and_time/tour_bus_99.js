...
tour_bus_99_main_stop_name = ["臺南<br />轉運站","臺南<br />火車站","延平郡王祠<br />(府前路)","赤崁樓","億載<br />金城","安平古堡<br />(安北路)","觀夕<br />平台","四草生態文化<br />園區(大眾廟)","四草野生動<br />物保護園區","七股<br />鹽山","黑面琵鷺<br />賞鳥亭"];
tour_bus_99_main_stop_time_consume = [0, 4, 10, 18, 38, 45, 50, 57, 60, 90, 120];
tour_bus_99_important_stop = [0, 1, 4, 5, 7, 9]; // 臺南轉運站, 臺南火車站, 安平古堡(安北路), 四草野生動物保護園區, 七股鹽山
...
tour_bus_99_time_return = [["10:55",end_stop,start_stop],["12:55",end_stop,start_stop],["16:15",end_stop,start_stop]];
// holiday schedule
