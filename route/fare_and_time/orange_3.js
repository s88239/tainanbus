...
orange_3_main_stop_name = ["善化<br />轉運站","蘇厝","安定","許中營","港口","中崙","和順","安南<br />醫院","中洲寮<br />保安宮","安通<br />路口","臺南<br />火車站","臺南公園<br />(公園路)"];
orange_3_main_stop_time_consume = [0, 12, 16, 23, 21, 25, 29, 30, 30, 45, 60, 65];
orange_3_important_stop = [0, 2, 7, 8, 10, 11]; // 善化轉運站, 安定, 安南醫院, 中洲寮保安宮, 臺南火車站, 臺南公園(公園路)
start_stop = 0;
end_stop = 7;
stop_1 = 3;
orange_3_time_go = [
